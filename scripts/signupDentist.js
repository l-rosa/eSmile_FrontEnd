...
const labelCro = document.querySelector("#labelCro");
...
sobrenome.addEventListener('keyup', () => {
   ...
   // CRO
function validateCro(cro) {
   if (regexCRO.test(cro.value)) {
      labelCro.setAttribute("style", "color:black")
      labelCro.innerHTML = "CRO:"
      cro.setAttribute("style", "border-color: green")
      validCro = true;
   } else {
      labelCro.setAttribute("style", "color:red")
      labelCro.innerHTML = "CRO invalido!"
      cro.setAttribute("style", "border-color: red", "color: red")
   }
}
// password
